...
altair_notes = {
    ...
    add_new_note: function() {
        if ($note_add_btn) {
            ...
            $note_add_btn.on("click", function(n) {
                n.preventDefault(), altair_md.card_show_hide($card_note, void 0, t, void 0)
            })
        }
    },
    open_note: function() {
        var t = function(t) {
            $card_note.find("#note_title").val(t.children(".md-list-heading").text()), $card_note.find("#note_content").val(t.children(".note_content_hid_class").val()),$card_note.find("#note_id").val(t.children(".note_id_hid_class").val())
        };
        $(notes_list_class).find("a").on("click", function(n) {
            n.preventDefault();
            var e = $(this);
            altair_md.card_show_hide($card_note, void 0, t, e), $(this).closest("li").siblings("li").removeClass("md-list-item-active").end().addClass("md-list-item-active")
        })
    },
