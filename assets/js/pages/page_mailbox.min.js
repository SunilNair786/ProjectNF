...
altair_mailbox = {
    ...
    create_message: function() {
        ...
        var i = $("#mail_progressbar"),
            t = i.find(".uk-progress-bar"),
            e = {
                action: "./upload/",
                single: !1,
                loadstart: function() {
                    t.css("width", "0%").text("0%"), i.removeClass("uk-hidden uk-progress-danger")
                },
                progress: function(i) {
                    i = Math.ceil(i), t.css("width", i + "%").text(i + "%"), "100" == i && setTimeout(function() {}, 1500)
                },
                error: function(e) {
                    i.addClass("uk-progress-danger"), t.css({
                        width: "100%"
                    }).text("100%")
                },
                abort: function(i) {
        ...
        UIkit.uploadSelect($("#mail_upload-select"), e), UIkit.uploadDrop($("#mail_upload-drop"), e)
    }
};