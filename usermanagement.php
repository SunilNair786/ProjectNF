                        ...
                        <div class="md-card md-card-hover">
                            <div class="md-card-head">
                                ...
                                <div class="uk-text-center">
                                   <a href="userprofile.php"> <img class="md-card-head-avatar" src="assets/img/avatars/avatar_08.png" alt=""/></a>
                                </div>
                                <a href="userprofile.php"> <h3 class="md-card-head-text uk-text-center">
