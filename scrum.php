...
<div class="uk-width-large-8-10 uk-container-center">
            ...
            <form class="uk-form-stacked">
                ...
                <div class="uk-margin-medium-bottom">
                    ...
                    <select class="uk-form-width-medium" name="task_assignee" id="task_assignee" data-md-selectize-inline>
                        ...
                        <option value="user_1">Shayne McDermott</option>
                        <option value="user_2">Kaylie Lehner</option>
                        <option value="user_3">Benedict Predovic</option>
                        <option value="user_4">Isabella O'Keefe</option>
                    </select>
                </div>
                <div class="uk-margin-medium-bottom">
        ...
        <div class="uk-modal-dialog">
            ...
            <form class="uk-form-stacked">
                <div class="uk-margin-medium-bottom">
                    ...
                    <p class="uk-margin-remove uk-text-large">Mollitia et aut rerum quia molestiae officia ratione laboriosam.</p>
                </div>
                <div class="uk-margin-medium-bottom">
                    <p class="uk-margin-small-bottom uk-text-muted">Description</p>
                    <p class="uk-margin-remove">Sapiente neque aperiam et illo facere quidem ipsa voluptas cupiditate accusamus corporis cupiditate dolorem perferendis fuga veritatis mollitia.</p>
                </div>
                <div class="uk-margin-medium-bottom">
                    <p class="uk-margin-small-bottom uk-text-muted">Assignee</p>
                    <p class="uk-margin-remove">Tyler Schoen</p>
                </div>
                <div class="uk-modal-footer uk-text-right">
    ...
    <script src="assets/js/pages/page_scrum_board.min.js"></script>
