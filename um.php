						...
						<div class="md-card-list-wrapper" id="mailbox">                
							<div class="md-card-list">
								<ul class="hierarchical_slide">
									...
									$userInfo = $collection->find(array('user_type'=> 'EU','status'=>'A'))->sort(array("created_date" => -1));									

									foreach($userInfo as $userArr){										
									?>
									<li>
		                            	<ul class="options">
										...
										<div class="md-card-list-item-sender">
											<span><?php echo $userArr['first_name'].' '.$userArr['last_name']; ?></span>
										</div>										
